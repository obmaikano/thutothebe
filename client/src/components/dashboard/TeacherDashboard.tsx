...
import { BookOpen, Calendar, Clock, FilePen, Users, BarChart2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-700 to-blue-900 rounded-xl p-6 shadow-md mb-6">
        <h1 className="text-2xl text-white font-bold mb-2">Welcome back, Teacher User!</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="col-span-1 lg:col-span-1">
          <div className="flex justify-between items-center mb-4">
            ...
            <a href="#" className="text-sm text-blue-600 hover:underline">Full calendar</a>
          </div>
          <div className="space-y-3">
