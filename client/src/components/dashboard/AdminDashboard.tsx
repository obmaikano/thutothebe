...
import { School, Users, BookOpen, Building, BarChart2, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-700 to-blue-900 rounded-xl p-6 shadow-md mb-6">
        <h1 className="text-2xl text-white font-bold mb-2">Welcome back, Super Admin!</h1>
