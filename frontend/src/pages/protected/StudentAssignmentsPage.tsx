...
import { FileText, Calendar, Clock, CheckCircle, XCircle, AlertCircle, AlertTriangle } from 'lucide-react';
                                ...
                                <div className="ml-6 flex flex-col items-end space-y-2">
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        {assignment.status === 'GRADED' && (
                                            <button className="bg-green-100 hover:bg-green-200 text-green-700 text-sm font-medium py-2 px-4 rounded-lg transition-colors">
                                                View Grade
                                            </button>
                                        )}
