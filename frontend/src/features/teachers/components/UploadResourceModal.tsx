...
import { X, Upload, BookOpen, FileText, Video, Link, Globe } from 'lucide-react';
import contentApi, { CreateContentRequest } from '../../../api/services/contentApi';
...
const UploadResourceModal: React.FC<UploadResourceModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title.trim() || !formData.description.trim() || !formData.courseId || !formData.url.trim()) {
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <TypeIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={20} />
              <select
                name="type"
                value={formData.type}
                onChange={handleInputChange}
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Resource description and usage instructions"
              required
            />
          </div>
          ...
          <div className="flex items-center">
            ...
            <label className="ml-2 block text-sm text-gray-700">
              Make resource active and visible to students
            </label>
          </div>
