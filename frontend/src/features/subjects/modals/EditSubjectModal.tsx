...
export const EditSubjectModal: React.FC<EditSubjectModalProps> = ({ extraObject }) => {
  ...
  if (!extraObject) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 mb-4">No subject information was provided for editing.</p>
        <button
          onClick={handleClose}
  ...
  if (isSuccess) {
    return (
      <div className="text-center py-8">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Subject Updated Successfully!</h3>
        <p className="text-gray-600">The subject information has been saved.</p>
      </div>
    );
  }
