...
import { fetchStudents, createStudent } from '../studentsSlice';
import { CreateStudentRequest } from '../../../api/services/studentApi';
import { Users, Plus, User, GraduationCap, Phone, Heart, Check } from 'lucide-react';
...
export const CreateStudentModal: React.FC<CreateStudentModalProps> = () => {
  ...
  const handleInputChange = (field: keyof CreateStudentRequest, value: string | number | boolean | undefined) => {
  ...
  if (isSuccess) {
    return (
      <div className="text-center py-8">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Student Onboarded Successfully!</h3>
        <p className="text-gray-600">The student has been added to the system and is ready for class assignment.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-gray-200">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Student Onboarding</h3>
          <p className="text-sm text-gray-600">Complete the student registration process</p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleInputChange('status', e.target.value as 'PENDING' | 'ACTIVE' | 'INACTIVE')}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
