...
import { Megaphone, Plus, Search, Bell, CheckCircle, Eye, Calendar, Tag, User, AlertTriangle, GraduationCap, Edit, Trash2 } from 'lucide-react';
...
const TeacherAnnouncementsPage: React.FC = () => {
  ...
  const [showMyAnnouncementsOnly, setShowMyAnnouncementsOnly] = useState(false);
  ...
  const handleDeleteAnnouncement = (announcement: Announcement, e: React.MouseEvent) => {
    e.stopPropagation();
    dispatch(openModal({
  ...
  const filteredAnnouncements = announcements.filter(announcement => {
    ...
    if (showMyAnnouncementsOnly && announcement.creatorId !== user?.id) return false;
    return true;
  });

  const myAnnouncements = announcements.filter(a => a.creatorId === user?.id);
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-2">View and manage announcements for your classes and school</p>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">My Announcements</div>
              </div>
            </div>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={(e) => setShowMyAnnouncementsOnly(e.target.checked)}
                className="checkbox checkbox-primary checkbox-sm"
              />
              <span className="text-sm text-gray-700">My announcements</span>
            </label>
          </div>
        </div>
      </div>
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-12 text-center">
                    ...
                    <p className="text-gray-600">
                      {showUnreadOnly ? 'No unread announcements at the moment.' : 
                       showMyAnnouncementsOnly ? 'You haven\'t created any announcements yet.' :
                       'There are no announcements to display.'}
                    </p>
                    {canCreateAnnouncements && !showMyAnnouncementsOnly && (
                      <button
                        onClick={handleCreateAnnouncement}
                      ...
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        {announcement.creatorId === user?.id && (
                          <>
                            ...
                            <button
                              onClick={(e) => handleDeleteAnnouncement(announcement, e)}
