...
import { Megaphone, Search, Bell, CheckCircle, Eye, Calendar, Tag, User, AlertTriangle, BookOpen } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-2">Stay updated with important school announcements and communications</p>
