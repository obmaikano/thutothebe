...
import { createContent, clearContentError } from '../contentSlice';
import { closeModal } from '../../common/modalSlice';
import { showNotification } from '../../common/commonSlice';
import { fetchCourses } from '../../courses/coursesSlice';
import { CreateContentRequest } from '../../../api/services/contentApi';
    ...
    <div className="p-6">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end space-x-3 pt-4">
          ...
          >
            {status === 'loading' ? 'Creating...' : 'Create Content'}
          </button>
        </div>
      </form>
    </div>
